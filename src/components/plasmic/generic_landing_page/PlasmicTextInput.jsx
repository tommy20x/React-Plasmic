...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: XlM4_2MgKHyU7/css
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: DPokyosL10nc1W/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchIcon
                className={classNames(projectcss.all, sty.svg__lErFj)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <CheckIcon
                className={classNames(projectcss.all, sty.svg___5ONrx)}
                role={"img"}
              />
            ),
