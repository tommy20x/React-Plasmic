...
import sty from "./PlasmicButton.module.css"; // plasmic-import: LVLS68bGRjt-/css
import AppleIcon from "./icons/PlasmicIcon__Apple"; // plasmic-import: Mru3UgawBST76-/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__cfzmc)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__jPpMw)}
                role={"img"}
              />
            ),
